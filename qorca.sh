...
#    echo "  -v 500    5.0.0 version with openmpi-4.1.1"
    ...
    echo ""
#    echo "Queue and maximum number of threads:"
#    echo "  -q single   24 threads with 1 proc per job"
#    echo "  -q small    40 threads with 4 proc per job"
#    echo "  -q xppn     24 threads"
#    echo "  -q xxchem   40 threads"
#    echo "  -q xp24mc4  24 threads"
#    echo "  -q xp24mc2  24 threads = xppn"
#    echo "  -q xp40mc12 40 threads = xxchem"
#    echo "  -q xp48mc8  48 threads"
#    echo "  -q xp36mc10 36 threads"
#    echo ""
    echo ""
}
